...
public class PointRenderer : MonoBehaviour {
    ...
    void Start () 
	{
        ...
        ballController.GetComponent<BallController>().InitBall();
        ballController.GetComponent<BallController>().InitBallPosition();
	...
	private void PlacePrefabPoints()
	{
                ...
                for (var i = 0; i < pointList.Count; i++)
        {
            ...
            Vector3 position = new Vector3(z, y, 1f-x) * plotScale;
    ...
    private void CreateParticles()
    {
       ...
       // Debug.Log("Row Count is " + rowCount);
        ...
        for (int i = 0; i < pointList.Count; i++)
        {
            ...
            particlePoints[i].position = new Vector3(z, y, x) * plotScale;

            //GlowColor = 
            // Set point color
            //particlePoints[i].startColor = new Color(x, y, z, 1.0f);
            particlePoints[i].startColor = new Color(z, y, x, 1.0f);
